...
| ::          | ::                                                                |
|             |                                                                   |
|     aa1     |     /bin/sh: ../ports/unix/micropython: No such file or directory |
|     1ab     |                                                                   |
|     a{}a1   |                                                                   |
|     1a{}b   |                                                                   |
|     12      |                                                                   |
...
| ::                | ::                                                                |
|                   |                                                                   |
|     hello { world |     /bin/sh: ../ports/unix/micropython: No such file or directory |
|     hello ] world |                                                                   |
+-------------------+-------------------------------------------------------------------+
...
| ::          | ::                                                                |
|             |                                                                   |
|     repr    |     /bin/sh: ../ports/unix/micropython: No such file or directory |
|     str     |                                                                   |
+-------------+-------------------------------------------------------------------+
...
| ::                                                     | ::                                                                |
|                                                        |                                                                   |
|     list.append() takes exactly one argument (0 given) |     /bin/sh: ../ports/unix/micropython: No such file or directory |
+--------------------------------------------------------+-------------------------------------------------------------------+
...
| ::           | ::                                                                |
|              |                                                                   |
|     __main__ |     /bin/sh: ../ports/unix/micropython: No such file or directory |
+--------------+-------------------------------------------------------------------+
...
| ::          | ::                                                                |
|             |                                                                   |
|     hello   |     /bin/sh: ../ports/unix/micropython: No such file or directory |
+-------------+-------------------------------------------------------------------+
...
| ::                                                                      | ::                                                                |
|                                                                         |                                                                   |
|     ['/Users/calrk/Documents/micropython-master/tests/cpydiff/modules'] |     /bin/sh: ../ports/unix/micropython: No such file or directory |
+-------------------------------------------------------------------------+-------------------------------------------------------------------+
