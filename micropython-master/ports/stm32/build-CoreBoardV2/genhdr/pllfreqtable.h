...
#define PLL_FREQ_TABLE_P(pll) (((((pll) >> 8) & 3) + 1) * 2)
typedef uint16_t pll_freq_table_t;
// (M, P/2-1, SYS) values for 25 MHz source
static const pll_freq_table_t pll_freq_table[22] = {
    (0 << 10) | (0 << 8) | 16,
    (25 << 10) | (3 << 8) | 24, // M=25 N=192 P=8 Q=4 vco_in=1.00 vco_out=192.00 pll48=48.00
    (1 << 10) | (0 << 8) | 25,
    (20 << 10) | (3 << 8) | 30, // M=20 N=192 P=8 Q=5 vco_in=1.25 vco_out=240.00 pll48=48.00
    (25 << 10) | (2 << 8) | 32, // M=25 N=192 P=6 Q=4 vco_in=1.00 vco_out=192.00 pll48=48.00
    (25 << 10) | (3 << 8) | 36, // M=25 N=288 P=8 Q=6 vco_in=1.00 vco_out=288.00 pll48=48.00
    (20 << 10) | (2 << 8) | 40, // M=20 N=192 P=6 Q=5 vco_in=1.25 vco_out=240.00 pll48=48.00
    (25 << 10) | (3 << 8) | 42, // M=25 N=336 P=8 Q=7 vco_in=1.00 vco_out=336.00 pll48=48.00
    (25 << 10) | (1 << 8) | 48, // M=25 N=192 P=4 Q=4 vco_in=1.00 vco_out=192.00 pll48=48.00
    (25 << 10) | (3 << 8) | 54, // M=25 N=432 P=8 Q=9 vco_in=1.00 vco_out=432.00 pll48=48.00
    (25 << 10) | (2 << 8) | 56, // M=25 N=336 P=6 Q=7 vco_in=1.00 vco_out=336.00 pll48=48.00
    (20 << 10) | (1 << 8) | 60, // M=20 N=192 P=4 Q=5 vco_in=1.25 vco_out=240.00 pll48=48.00
    (25 << 10) | (2 << 8) | 64, // M=25 N=384 P=6 Q=8 vco_in=1.00 vco_out=384.00 pll48=48.00
    (25 << 10) | (1 << 8) | 72, // M=25 N=288 P=4 Q=6 vco_in=1.00 vco_out=288.00 pll48=48.00
    (25 << 10) | (1 << 8) | 84, // M=25 N=336 P=4 Q=7 vco_in=1.00 vco_out=336.00 pll48=48.00
    (25 << 10) | (0 << 8) | 96, // M=25 N=192 P=2 Q=4 vco_in=1.00 vco_out=192.00 pll48=48.00
    (25 << 10) | (1 << 8) | 108, // M=25 N=432 P=4 Q=9 vco_in=1.00 vco_out=432.00 pll48=48.00
    (20 << 10) | (0 << 8) | 120, // M=20 N=192 P=2 Q=5 vco_in=1.25 vco_out=240.00 pll48=48.00
    (25 << 10) | (0 << 8) | 144, // M=25 N=288 P=2 Q=6 vco_in=1.00 vco_out=288.00 pll48=48.00
    (25 << 10) | (0 << 8) | 168, // M=25 N=336 P=2 Q=7 vco_in=1.00 vco_out=336.00 pll48=48.00
    (25 << 10) | (0 << 8) | 192, // M=25 N=384 P=2 Q=8 vco_in=1.00 vco_out=384.00 pll48=48.00
    (25 << 10) | (0 << 8) | 216, // M=25 N=432 P=2 Q=9 vco_in=1.00 vco_out=432.00 pll48=48.00
};
#endif
