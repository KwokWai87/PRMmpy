...
QDEF(MP_QSTR_VCP_plus_MSC_plus_HID, (const byte*)"\x98\x4b\x0b" "VCP+MSC+HID")
...
QDEF(MP_QSTR_AF5_I2S2, (const byte*)"\xb2\xd0\x08" "AF5_I2S2")
QDEF(MP_QSTR_AF5_SPI1, (const byte*)"\x93\x1b\x08" "AF5_SPI1")
QDEF(MP_QSTR_AF5_SPI2, (const byte*)"\x90\x1b\x08" "AF5_SPI2")
QDEF(MP_QSTR_AF6_I2S2, (const byte*)"\xd1\x6f\x08" "AF6_I2S2")
...
QDEF(MP_QSTR_SPIFLASH_CS, (const byte*)"\xb0\x18\x0b" "SPIFLASH_CS")
QDEF(MP_QSTR_SPIFLASH_MISO, (const byte*)"\xd8\x3d\x0d" "SPIFLASH_MISO")
QDEF(MP_QSTR_SPIFLASH_MOSI, (const byte*)"\x58\x45\x0d" "SPIFLASH_MOSI")
QDEF(MP_QSTR_SPIFLASH_SCK, (const byte*)"\xfb\x70\x0c" "SPIFLASH_SCK")
...
QDEF(MP_QSTR_ADC123_COMMON, (const byte*)"\x21\x9e\x0d" "ADC123_COMMON")
...
QDEF(MP_QSTR_AMP, (const byte*)"\x19\xb7\x03" "AMP")
...
QDEF(MP_QSTR_DutyCycle, (const byte*)"\xa9\x05\x09" "DutyCycle")
...
QDEF(MP_QSTR_FREQ, (const byte*)"\xa5\x42\x04" "FREQ")
...
QDEF(MP_QSTR_Frequency, (const byte*)"\xc1\xae\x09" "Frequency")
...
QDEF(MP_QSTR_THDN, (const byte*)"\x93\xe6\x04" "THDN")
...
QDEF(MP_QSTR_ad717x, (const byte*)"\xa9\xc3\x06" "ad717x")
...
QDEF(MP_QSTR_dFft, (const byte*)"\x75\x7f\x04" "dFft")
QDEF(MP_QSTR_data, (const byte*)"\x15\xdc\x04" "data")
QDEF(MP_QSTR_datalogger, (const byte*)"\x81\x4a\x0a" "datalogger")
...
QDEF(MP_QSTR_dmath, (const byte*)"\xf1\xbc\x05" "dmath")
...
QDEF(MP_QSTR_is_communication_ok, (const byte*)"\x9b\xf0\x13" "is_communication_ok")
...
QDEF(MP_QSTR_measure_freq, (const byte*)"\x02\xef\x0c" "measure_freq")
...
QDEF(MP_QSTR_nums, (const byte*)"\xa0\xc9\x04" "nums")
...
QDEF(MP_QSTR_prm_fft, (const byte*)"\x01\x19\x07" "prm_fft")
...
QDEF(MP_QSTR_read_volt, (const byte*)"\x89\x0e\x09" "read_volt")
...
QDEF(MP_QSTR_set_sampling_rate, (const byte*)"\xe6\xf1\x11" "set_sampling_rate")
