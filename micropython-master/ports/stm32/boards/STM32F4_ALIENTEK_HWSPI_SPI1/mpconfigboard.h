...
// // use Timer 5 channel 0/1/2/3 to Capture 
// #define MICROPY_HW_TIMER5_CAPTURE_CHANNEL0  (pin_A0)
// #define MICROPY_HW_TIMER5_CAPTURE_CHANNEL1  (pin_A1)
...
// SPI buses
#if 1
#define MICROPY_HW_SPI1_NSS  (pin_B14)
...
#define MICROPY_HW_SRAM_BANK                (NOR_MEMORY_ADRESS3)
