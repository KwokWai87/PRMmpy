# -*- coding: UTF-8 -*-
from mix.driver.ic.i2c_mux_base import I2CMUXBase
...
class TCA9548(I2CMUXBase):
    ...
    '''
    rpc_public_api = [
        "set_channel_state", "get_channel_state", "open_all_channel", "close_all_channel"
    ...
    def set_channel_state(self, channel):
        ...
        self._i2c_bus.send(self._dev_addr, write_data)
    ...
    def get_channel_state(self, channel):
        ...
        '''
        assert type(channel) is list and len(channel) <= 8
        ret = self._i2c_bus.recv(self._dev_addr, 1)
        read_data = []
        for index in range(len(channel)):
